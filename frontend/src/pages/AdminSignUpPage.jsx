...
import { BookOpenTextIcon, EyeIcon, EyeOff, Loader2, Lock, Mail, MessageSquare, User, UserCog } from 'lucide-react'
...
const AdminSignUpPage = () => {
  ...
  const {signup , isSigningUp} = useAuthAdminStore()
        ...
        <div className='w-full max-w-md space-y-5'>
          ...
          <div className='text-center mb-6'>
            <div className='flex flex-col items-center gap-2 group'>
              ...
              <p className='text-base-content/60'>Start Your Adminstration Journey!</p>
            </div>
          ...
          <div className="text-center">
            ...
            <Link to="/admin/login" className='link link-primary'>Sign in</Link>
            </p>
