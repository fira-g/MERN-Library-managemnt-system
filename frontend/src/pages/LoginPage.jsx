...
import { BookOpenText, EyeIcon, EyeOff, Loader2, Lock, Mail, MessageSquare } from 'lucide-react'
...
const LoginPage = () => {
  const [showPassword , setShowPassword] = useState(false)
    ...
    const {login , isLoggingUp, authUser } = useAuthUserStore()
        ...
        <div className='w-full max-w-md space-y-5'>
          ...
          <div className='text-center mb-6'>
            <div className='flex flex-col items-center gap-2 group'>
              ...
              <p className='text-base-content/60'>Access The Books You Wanted!</p>
            </div>
          ...
          <div className="text-center">
            ...
            <Link to="/user/signup" className='link link-primary'>Sign Up</Link>
            </p>
